    ...
    return (
        ...
        >
            ...
            <div className="p-4 relative z-10 w-full text-center" >
                ...
                >Start your journey to fun and enlightenment today! Welcome to QuizWiz where trivia meets entertainment! Dive into a world of puzzles and challenges, expand your knowledge, and join a vibrant community of learners.</p>
                <div className="mt-4">
                    <Link href={"/"}>
