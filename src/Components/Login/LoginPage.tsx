...
const LoginPage = (props: any) => {
  ...
  return (
    <div className="bgColor max-sm:min-h-[93vh] max-sm:max-h-[93vh] min-h-screen flex justify-center items-center w-full">
      <div
        className={`${Styles.container} rounded-lg w-full md:w-[80%] lg:w-[60%] xl:w-[45%] 2xl:w-[30%] h-fit flex justify-center pt-8 pb-8 `}
      >
        <div className={`flex flex-col items-center space-y-8 w-full`}>
          ...
          {isLogin && (
            <h1
              className={`${Styles.headerColor} text-3xl max-md:text-2xl font-black`}
            >
            ...
            >
              ...
              <div className="flex justify-end mb-5">
                <Link
                  ...
                  className={`${Styles.textColor} font-bold`}
                >
                  Forgot password?
                </Link>
              </div>
